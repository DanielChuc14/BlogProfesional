...
namespace BlogPlatform.Infrastructure.Migrations
{
    ...
    public partial class InitialCreate : Migration
    {
        ...
        {
            migrationBuilder.Sql("DROP TRIGGER IF EXISTS trg_asp_net_users_updated_at ON \"AspNetUsers\";");
            migrationBuilder.Sql("DROP TRIGGER IF EXISTS trg_refresh_tokens_updated_at ON refresh_tokens;");
